...
public class DispositionLetter{
	public static void main(String[] args) {
		Rectangle pageSize = new Rectangle(144, 720); // set the pagesize
		Document document = new Document();
		try {
			PdfWriter.getInstance(document, new FileOutputStream("pdf/HelloWorld.pdf"));
			...
			//字体 
			BaseFont baseFT = BaseFont.createFont("font/STSong.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
			Font font0 = new Font(baseFT,12); //12号字体,宋体
			baseFT = BaseFont.createFont("font/Arial.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
			...
			//第一行第一列  
			//图片
			Image png = Image.getInstance("image/image001.png"); 
			png.scalePercent(40); 
			...
			t1.addCell(c1);
			//第一行第二列
			c1 = new PdfPCell(new Paragraph("The Commonwealth of Massachusetts\n\n" +
					"Executive Office of Health & Human Services\n\n" +
					"Department Of Developmental Services\n\n" +
					"Division of Investigations - Central/West Region",font2));
