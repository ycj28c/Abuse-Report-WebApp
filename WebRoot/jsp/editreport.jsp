...
<body>
	<div id="container">
		...
		==================================================================<br>
		<form
			action="jsp/UpdateReportServlet?reportid=<%=report.getReportid()%>"
			method="post">
			<table align="left" border="1" style="border-collapse: collapse;">
				...
				<tr>
					...
					: ""%>>Episodic</option>
					</select> <select name="abusefrequencytend" id="abusefrequencytend">
							<option></option>
				...
				<tr>
					...
					<td colspan="2">
						...
						<%=hashAbuseType.containsKey("Physical") ? "checked" : ""%>>Physical
						<input type="checkbox" name="abusetype" value="Omission"
						<%=hashAbuseType.containsKey("Omission") ? "checked" : ""%>>Omission
						<input type="checkbox" name="abusetype" value="Sexual"
						<%=hashAbuseType.containsKey("Sexual") ? "checked" : ""%>>Sexual
						<input type="checkbox" name="abusetype" value="Emotional"
						<%=hashAbuseType.containsKey("Emotional") ? "checked" : ""%>>Emotional
						<br> <%
 	if (hashAbuseType.containsKey("Other")) {
 %> <input type="checkbox" name="abusetype" id="abusetypeother"
						value="Other" checked>Other: <input type="text"
						name="abusetypeothertext" id="abusetypeothertext"
						value=<%=hashAbuseType.get("Other")%> style="width:80%"> <%
 	} else {
 %> <input type="checkbox" name="abusetype" id="abusetypeother"
 ...
 %> <br> <label for="abusetype" class="error"></label>
					...
					<td colspan="2">
						...
						%> <label><input name="awareof" type="radio" value="yes"
							checked />yes</label> <label><input name="awareof" type="radio"
							value="no" />no</label> <%
 	} else {
 %> <label><input name="awareof" type="radio" value="yes" />yes</label>
						<label><input name="awareof" type="radio" value="no"
							checked />no</label> <%
 	}
				...
				<tr>
					...
					<td colspan="4">
						...
						%> <label><input name="dppchotline" type="radio"
							value="no" checked />no</label> <label><input name="dppchotline"
 ...
 %> <label><input name="dppchotline" type="radio" value="no" />no</label>
						<label><input name="dppchotline" type="radio" value="yes"
							checked />yes</label> <label><input name="dppchotlinetext"
							id="dppchotlinetext" type="text" style="width:70%"
							value="<%=report.getDppchotline()%>"> </label> <%
 	}
 %>
					</td>
				</tr>
				<tr>
					...
					<td colspan="4">
						...
						%> <label><input name="investigatorrisk" type="radio"
							value="no" checked />no</label> <label><input
 ...
 %> <label><input name="investigatorrisk" type="radio"
							value="no" />no</label> <label><input name="investigatorrisk"
							type="radio" value="yes" checked />yes</label> <label><input
							name="investigatorrisktext" id="investigatorrisktext" type="text"
							style="width:70%" value="<%=report.getInvestigatorrisk()%>">
					</label> <%
 	}
 %>
					</td>
				...
				<tr>
					<td colspan="6"><textarea style="width:100%"
							name="narrativeform" rows="6"><%=report.getNarrativeform()%></textarea>
					</td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6"><textarea style="width:100%" rows="6"
							name="risklevel"><%=report.getRisklevel()%></textarea>
					</td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6"><textarea style="width:100%" rows="6"
							name="resultinginjure"><%=report.getResultinginjure()%></textarea>
					</td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6" align="left" valign="top"><textarea
							style="width:100%" rows="5" name="witness"><%=report.getWitness()%></textarea>
					</td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6"><textarea rows="5" style="width:100%"
							name="caregiverrelationship"><%=report.getCaregiverrelationship()%></textarea>
					</td>
				</tr>
				</tr>
				<tr>
						...
						<div id="thumbnails">
							<table id="infoTable" border="0" width="100%"
								...
								<tr id="SWFUpload_0_9<%=i%>">
									...
									<td style="width:80;"><font color="green">upload
											file sucessfully!</font></td>
									<td style="width:50;text-align:right"><a
										href="javascript:deleteFile('SWFUpload_0_9<%=i%>')">delete</a>
									</td>
