...
<script type="text/javascript">
	...
	function checkPLN() {
		...
		if (publiclognumber == '')
			return false;
		var url = "jsp/CheckPublicLogNumberServlet?publiclognumber="
				+ publiclognumber;
		...
		if (pln.readyState == 4) {
			if (pln.status == 200) {
				...
				if (xxoo == "new investigation") {
					...
					var investigationform = document
							.getElementById("newinvestigation");
					...
					if (xml.getElementsByTagName("report") != null
							&& xml.getElementsByTagName("report") != "") {
					...
					if (xml.getElementsByTagName("disposition") != null
							&& xml.getElementsByTagName("disposition") != "") {
						var dispositionid_dis = xml
								.getElementsByTagName("dispositionid_dis")[0].childNodes[0].nodeValue;
						var dispositionid = document
								.getElementById("dispositionid");
						dispositionid.value = dispositionid_dis;

						var description_dis = xml
								.getElementsByTagName("description_dis")[0].childNodes[0].nodeValue;
						var disdescription = document
								.getElementById("disdescription");
						disdescription.value = description_dis;

						var attachpath_dec = xml
								.getElementsByTagName("attachpath_dis")[0].childNodes[0].nodeValue;
						var attacholdname_dec = xml
								.getElementsByTagName("attacholdname_dis")[0].childNodes[0].nodeValue;
						var disattachment = document
								.getElementById("disattachment");
					...
					if (xml.getElementsByTagName("respond") != null
							&& xml.getElementsByTagName("respond") != "") {
						var respondid_res = xml
								.getElementsByTagName("respondid_res")[0].childNodes[0].nodeValue;
						var respondid = document.getElementById("respondid");
						respondid.value = respondid_res;

						var content_res = xml
								.getElementsByTagName("content_res")[0].childNodes[0].nodeValue;
						var resdescription = document
								.getElementById("resdescription");
						resdescription.value = content_res;
					}
					if (xml.getElementsByTagName("decision") != null
							&& xml.getElementsByTagName("decision") != "") {
						var decisionid_dec = xml
								.getElementsByTagName("decisionid_dec")[0].childNodes[0].nodeValue;
						var decisionid = document.getElementById("decisionid");
						decisionid.value = decisionid_dec;

						var description_dec = xml
								.getElementsByTagName("description_dec")[0].childNodes[0].nodeValue;
						var desdescription = document
								.getElementById("desdescription");
						desdescription.value = description_dec;

						var attachpath_dec = xml
								.getElementsByTagName("attachpath_dec")[0].childNodes[0].nodeValue;
						var attacholdname_dec = xml
								.getElementsByTagName("attacholdname_dec")[0].childNodes[0].nodeValue;
						var desattachment = document
								.getElementById("desattachment");
...
<body>
	<div id="container">
		...
		================================================================== <br>
		<form action="jsp/NewInvestigationServlet" method="post"
			enctype="multipart/form-data" id="newinvestigation">
			<table align="left" border="1" id="tableone"
				style="border-collapse: collapse;">
				<tr>
					<td colspan="3" align="center" id="title">INVESTIGATION</td>
				</tr>
				<tr>
					<td colspan="3">PLN :<input type="text" name="publiclognumber"
						id="publiclognumber" /> <input type="button"
						value="Check Available" onclick="checkPLN()" id="checkAvailable" />
						<input type="button" value="Reset" onclick="initElement()"
						id="reSearch" disabled /> <br> <label for="publiclognumber"
						class="error"></label>
					</td>
				</tr>
			</table>
			<br> <br> <br> <br>
			<table align="left" border="1" id="tabletwo"
				style="border-collapse: collapse;display:none;">
				<tr>
					<td colspan="3" align="center">Report</td>
				</tr>
				<tr>
					<td colspan="3" align="left">ReportID :<input type="text"
						value="" name="reportid" id="reportid" disabled> Date :<input
						type="text" name="date" id="date" disabled> Status :<input
						type="text" name="status" id="status" disabled> <br>
				...
				<tr style="display:none">
					<td>DispositionID :</td>
					<td colspan="2" align="left"><input type="text" value=""
						name="dispositionid" id="dispositionid">
					</td>
				</tr>
				<tr>
					<td>Description :</td>
					<td colspan="2" align="left"><textarea style="width:100%;"
							name="disdescription" id="disdescription"></textarea>
					</td>
				</tr>
				<tr>
					<td>Attachment :</td>
					<td colspan="2" align="left"><input type="file"
						name="disattachment" id="disattachment" disabled>
					</td>
				</tr>
				<tr>
				...
				<tr style="display:none">
					<td>RespondID :</td>
					<td colspan="2" align="left"><input type="text" value=""
						name="respondid" id="respondid">
					</td>
				</tr>
				<tr>
					<td>Description :</td>
					<td colspan="2" align="left"><textarea style="width:100%;"
							name="resdescription" id="resdescription" disabled></textarea> <br>
				...
				<tr style="display:none">
					<td>DecisionID :</td>
					<td colspan="2" align="left"><input type="text" value=""
						name="decisionid" id="decisionid">
					</td>
				</tr>
				<tr>
					<td>Description :</td>
					<td colspan="2" align="left"><textarea style="width:100%;"
							name="desdescription" id="desdescription" disabled></textarea>
					</td>
				</tr>
				<tr>
					<td>Attachment :</td>
					<td colspan="2" align="left"><input type="file"
						name="desattachment" id="desattachment" disabled>
					</td>
				</tr>
				<tr>
					<td colspan="3" align="right"><input type="submit"
						value="Submit" id="submitform" disabled /> <input type="reset"
						value="Reset" id="resetform" onclick="initElement()" disabled />
