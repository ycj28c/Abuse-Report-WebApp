					 ...
					 <th colspan="8"> 
        				...
        				<%if(pagex.getTotalPage()<6) {
        					for(int indexx=1;indexx<=pagex.getTotalPage();indexx++){%>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=indexx%>"><%=indexx %></a>
        				<% }
        				}
        				else{
        				...
        				<%  	}%>
        						<a>...</a>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.getTotalPage()%>"><%=pagex.getTotalPage()%></a>
        				<%	}
        				...
        				<%	}
        						...
        						<a href="jsp/SuperAdminReportListServlet?pageindex=1">1</a>
        						<a>...</a>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.getTotalPage()-3%>"><%=pagex.getTotalPage()-3%></a>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.getTotalPage()-2%>"><%=pagex.getTotalPage()-2%></a>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.getTotalPage()-1%>"><%=pagex.getTotalPage()-1%></a>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.getTotalPage()%>"><%=pagex.getTotalPage()%></a>
        				<%	}
        					else{%>
        						<a href="jsp/SuperAdminReportListServlet?pageindex=1">1</a>
        				...
        				<%if(pagex.nextPage<=pagex.getTotalPage()) {%>
        					<a href="jsp/SuperAdminReportListServlet?pageindex=<%=pagex.nextPage%>">Next Page</a> 
        				<%}else{%>
        					<a>Next Page</a>
        				<%} %>
					 </th>
